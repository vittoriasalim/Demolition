...
@rem ##########################################################################
@rem
@rem  final_demolition startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FINAL_DEMOLITION_OPTS to pass JVM options to this script.
...
:fail
rem Set variable FINAL_DEMOLITION_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FINAL_DEMOLITION_EXIT_CONSOLE%" exit 1
exit /b 1
